...
export class EventService {
  ...
  create(event: Event, notify: boolean = false): Promise<Event> {
    return new Promise((resolve, reject) => {
      this.eventHttpService.createEvent(event, notify)
        .then((event) => {
  ...
  update(event: Event, notify: boolean = false) {
    return new Promise<Event>((resolve, reject) => {
      this.eventHttpService.updateEvent(this.currentEvent, notify)
        .then((event) => {
          resolve(event)
        })
        .catch((error) => {
